...
<body>
  ...
  <img 
    ...
    alt="edit Icon" 
    class="edit" 
    onclick="showDeleteModal('<?= base_url('booking/hapus_data/' . $data->id) ?>')"></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('booking/tambah_data') ?>" method="POST">
          <div class="mb-3">
...
function logout() {
    // Redirect ke URL dashboard
    window.location.href = "http://localhost/bookingkelas/dashboard";
}
