...
<body>
    ...
    <!-- Tulisan Dashboard -->
    <h1 class="teks">BOOKING RUANGAN</h1>

    <!-- sidebar icon -->
    <div class="sidebar">
    <ul>
        <li>
            <a href="http://localhost/bookingkelas/dashboard_mahasiswa">
                <img src="<?= base_url('assets/gambar/dashboard.png') ?>" alt="dashboard Icon" class="icon"> 
                Dashboard
            </a>
        </li>
        <li>
            <a href="http://localhost/bookingkelas/booking_mahasiswa">
                <img src="<?= base_url('assets/gambar/booking.png') ?>" alt="bookingruangan Icon" class="icon">
                Booking Ruangan
            </a>
        </li>
        <li>
            <a href="http://localhost/bookingkelas/pinjamalat_mahasiswa">
  ...
  <div class="container">
    <table class="tabelcustom">
      ...
      <tbody>
  <?php foreach ($booking_mhs as $data) : ?>
    <tr>
    ...
    alt="edit Icon" 
    class="edit" 
    onclick="showDeleteModal('<?= base_url('booking_mahasiswa/hapus_data/' . $data->id) ?>')"></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('booking_mahasiswa/tambah_data') ?>" method="POST">
          <div class="mb-3">
