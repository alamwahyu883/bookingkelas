...
<body>
    ...
    <table class="tabelcustom">
      ...
      <tbody>
  <?php foreach ($pinjamalat_mhs as $data) : ?>
    <tr>
    ...
    alt="edit Icon" 
    class="edit" 
    onclick="showDeleteModal('<?= base_url('pinjamalat_mahasiswa/hapus_data/' . $data->id) ?>')"></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('pinjamalat_mahasiswa/tambah_data') ?>" method="POST">
          <div class="mb-3">
